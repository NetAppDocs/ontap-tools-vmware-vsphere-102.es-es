...
* Todos los almacenes de datos montados en el clúster de hosts deben ser almacenes de datos VMFS con protocolo iSCSI/FC. No se admiten los almacenes de datos VMFS con protocolos NVMe/FC y NVMe/TCP.
...
. Seleccione *Agregar*.
. En la ventana *Protect cluster*, durante la operación de creación, solo se admite la acción de eliminación. Puede eliminar y volver a agregar la protección. Durante la operación de protección Modificar clúster de hosts, la opción de edición está disponible. Puede editar o eliminar las relaciones mediante las opciones del menú de kebab.
